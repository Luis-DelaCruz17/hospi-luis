...
SET ANSI_NULLS ON
GO
CREATE VIEW [dbo].[Vista-Medico]
AS
SELECT        MEDICO.ESPECIALIDAD.NOMESP, MEDICO.MEDICO.APEPATMED, MEDICO.MEDICO.NOMMED, MEDICO.MEDICO_ESPECIALIDAD.DESCESP
...
Begin DesignProperties = 
   ...
   End
End
', 'SCHEMA', N'dbo', 'VIEW', N'Vista-Medico', NULL, NULL
GO
DECLARE @xp int
SELECT @xp=1
EXEC sp_addextendedproperty N'MS_DiagramPaneCount', @xp, 'SCHEMA', N'dbo', 'VIEW', N'Vista-Medico', NULL, NULL
GO
